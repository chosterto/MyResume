...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        4$^{\text{th}}$ Year Software Co-op Engineering Student at McMaster University
        % \vspace{5 pt}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\customref{mailto:choj35@mcmaster.ca}{choj35@mcmaster.ca}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Bachelor in Software Engineering, McMaster University}\end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item \textbf{GPA:} 3.9/4.0
                \item \textbf{Coursework:} Computer Architecture, Discrete Math, Object-Oriented Programming, Data Structures and Algorithms, Linear Optimization, Digital Signals and Systems, Control Systems
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Extracurriculars}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Software Team Lead}, \textbf{\customref[blue]{https://www.mcmastermarsrover.com/}{McMaster Mars Rover Team}} -- Hamilton, ON\end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Led a team of 10-12 people to enhance and maintain rover stack using tools such as Kanban and git 
                \item Used ROS 2 to create complex control systems on Jetson AGX Orin such as SLAM, point-to-point navigation, differential GNSS RTK, and inverse and forward arm kinematics to complete various on-rover tasks at competition
                \item Developed custom firmware for STM32 motor controller boards with PID over CAN bus using STM32CubeIDE for drivetrain and arm actuation
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Member and leader of the programming section for FRC Team 772, the \textbf{\customref[blue]{https://www.sabrerobotics.com/}{Sabre Bytes}} and Drive Team Operator for 2021-2022 season
    ...
    \section{Experience}
        ...
        \begin{twocolentry} {
            ...
            \textbf{Embedded Developer Intern}, \textbf{\customref[blue]{https://www.geotab.com/}{Geotab}} -- Oakville, ON\end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Developed embedded GNSS/IMU software for fleet telematics devices using POSIX C and NuttX to support harsh driving detection and sensor calibration
                \item Troubleshot and fixed customer-facing issues for Amazon GO devices by debugging legacy GNSS firmware and pinpointing root cause through drive tests
                \item Wrote tools to query trip logs and monitor performance of up to 1000 field devices using Python for validating new firmware releases
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Managed a group of 20 to 30 kids interested in learning STEM, teaching basic programming concepts using MakeCode
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{\customref[blue]{https://drive.google.com/drive/folders/1CYcbyKpHjH-DZPU5JNhlTpTpQmKvzFWN}{Minecraft Turing Machine}}\end{twocolentry}
        ...
        \begin{twocolentry}{ Feb 2022 – March 2022 }
            \textbf{\customref[blue]{https://github.com/chosterto/PurePursuitTracking}{Pure Pursuit Path Controller}}\end{twocolentry}
        ...
        % \begin{twocolentry}{ Feb 2022 – March 2022 }
        %     \textbf{\customref[blue]{https://github.com/chosterto/Regression-Analyzer}{Polynomial Regression Calculator}}\end{twocolentry}
        ...
        %         \item Used by FIRST Robotics Team 772 to find relationship between distance of Hub and flywheel speed needed to shoot balls into Hub
        %     \end{highlights}
        % \end{onecolentry}
    ...
    \section{Skills}
        ...
        \begin{onecolentry}
            \textbf{Languages:} C++, C, Java, Python, Verilog, Bash, YAML, UML, SQL
        \end{onecolentry}
        ...
        \begin{onecolentry}
            ...
            PID, SPI, I2C, CAN, UART, SonarQube, Maven, NuttX
        \end{onecolentry}
