...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        3$^{\text{rd}}$ Year Software Co-op Engineering Student at McMaster University
        % \vspace{5 pt}
    ...
    \section{Extracurriculars}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Lead a team of 10-12 people to successfully enhance and maintain current rover software stack using tools such as Git and Kanban boards
                \item Using ROS 2 to develop complex control systems for the rover on Jetson AGX Orin such as automonous 3D mapping with SLAM, 2D GPS mapping and RTK, and point-to-point navigation with obstacle avoidance
                \item Developed firmware using Arduino IDE for sensor boards to communicate GPS, IMU, and temperature data over ethernet using micro-ROS and controlled custom STM32 motor controller boards with PID over CAN bus using STM32CubeIDE
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Developed and maintained GPS and IMU embedded software for telematics devices used in commercial fleet vehicles
                \item Worked with POSIX C and NuttX RTOS to process raw sensor data, incorporate RLS filtering for IMU calibration, and implement algorithms used for harsh driving detection
