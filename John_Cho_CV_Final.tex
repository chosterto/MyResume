...
\begin{document}
    ...
    \section{Extracurriculars}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Using ROS 2 to develop complex control systems for the rover on Jetson AGX Orin such as automonous 3D mapping with SLAM, 2D GPS mapping (mapviz), and point-to-point navigation with obstacle avoidance
    ...
    \section{Skills}
        ...
        \begin{onecolentry}
            ...
            PID, SPI, I2C, CAN, UART, SonarQube, Maven, DB2
        \end{onecolentry}
