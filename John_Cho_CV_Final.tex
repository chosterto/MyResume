    ...
    \section{Extracurriculars}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Developed firmware for sensor boards to communicate GPS, IMU, and temperature data over ethernet to Jetson AGX Orin using micro-ROS and control custom motor controller boards with PID over CAN bus
