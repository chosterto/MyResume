    ...
    \section{Extracurriculars}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Developed firmware using Arduino IDE and STM32CubeIDE for sensor boards to communicate GPS, IMU, and temperature data over ethernet using micro-ROS and control custom STM32 motor controller boards with PID over CAN bus
