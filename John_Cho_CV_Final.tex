...
\begin{document}
    ...
    \section{Extracurriculars}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Used ROS 2 to develop complex control systems for the rover such as automonous 3D mapping with SLAM, 2D GPS mapping (mapviz), and point-to-point navigation with obstacle avoidance
                ...
                \item Team placed 1$^{\text{st}}$ in Canada (4th overall) at \customref{https://circ.cstag.ca/2023/}{Summer CIRC 2023} and 2$^{\text{nd}}$ at \customref{https://circ.cstag.ca/2024-winter/}{Winter CIRC 2024}
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Projects}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Created a Turing Machine using Minecraft redstone, complete with a functional memory tape and 8-bit register to store current state, read symbol, and tape direction
                ...
                \item Utilized many concepts in digital systems and discrete math such as combinational logic, k-maps, and state minimization
            \end{highlights}
        \end{onecolentry}
